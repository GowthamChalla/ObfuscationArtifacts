...
set _DeploySetParametersFile=%RootPath%Microsoft.Dynamics.Obfuscation.WebSite.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Microsoft.Dynamics.Obfuscation.WebSite.zip" (
echo "%RootPath%Microsoft.Dynamics.Obfuscation.WebSite.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Microsoft.Dynamics.Obfuscation.WebSite.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Microsoft.Dynamics.Obfuscation.WebSite.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Microsoft.Dynamics.Obfuscation.WebSite.deploy-readme.txt" (
...
start notepad "%RootPath%Microsoft.Dynamics.Obfuscation.WebSite.deploy-readme.txt"
)
echo =========================================================
goto :eof
